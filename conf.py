...
BLOG_AUTHOR = "Hiromasa OHASHI"  # (translatable)
BLOG_TITLE = "hiromasa.info"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.hiromasa.info/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.hiromasa.info/"
BLOG_EMAIL = "stoicheia1986@gmail.com"
BLOG_DESCRIPTION = "blog by Hiromasa OHASHI"  # (translatable)
...
#   ]
TAG_TRANSLATIONS = [
        {'ja': '音声認識', 'en': 'speech_recognition'},
        {'ja': '音響モデル', 'en': 'acoustic_model'},
        {'ja': '言語モデル', 'en': 'language_model'},
        {'ja': 'ガンマ分布', 'en': 'gamma_probability_density_distribution'},
        {'ja': '確率分布', 'en': 'probability_density_distribution'},
	{'ja': 'librosa'     , 'en': 'librosa'     },
	{'ja': 'pycon'       , 'en': 'pycon'       },
	{'ja': 'scipy'       , 'en': 'scipy'       },
	{'ja': 'travisci'    , 'en': 'travisci'    },
	{'ja': 'python'      , 'en': 'python'      },
	{'ja': 'kaldi'       , 'en': 'kaldi'       },
	{'ja': 'pydata'      , 'en': 'pydata'      },
	{'ja': 'samba'       , 'en': 'samba'       },
	{'ja': 'ndarray'     , 'en': 'ndarray'     },
	{'ja': 'nikola'      , 'en': 'nikola'      },
	{'ja': 'scikit-learn', 'en': 'scikit-learn'},
	{'ja': 'numpy'       , 'en': 'numpy'       },
	{'ja': 'hexdump'     , 'en': 'hexdump'     },
	{'ja': 'osx'         , 'en': 'osx'         },
	{'ja': 'github'      , 'en': 'github'      },
        ]
...
EXTRA_HEAD_DATA = """
<meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' data: http://*.google-analytics.com https://*.hiromasa.info https://*.google-analytics.com https://code.jquery.com http://*.disqus.com https://disqus.com https://*.disqus.com https://*.disquscdn.com https://*.cloudinary.com http://www.gravatar.com https://www.googletagmanager.com https://*.twitter.com http://*.facebook.com https://*.facebook.com https://*.facebook.net http://*.hatena.ne.jp https://*.st-hatena.com https://cdnjs.cloudflare.com https://fonts.gstatic.com;">
